...
/**
 * _getenv -It as gets value of an environ variable
 * @info: Structures containing potential arguments. Used to maintain  a constant            function protoype
...
/**
 * _mysetenv - Initializes a new environment var,
...
/**
 * _myunsetenv - Removes an environment var
 * @info: Structures containing potential arguments. Used to maintain
 *            constant function prototype.
 * Returns: Always 0
 *
